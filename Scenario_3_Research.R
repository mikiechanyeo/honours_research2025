...
# --- keep your objects from above (beta_mean, sigma_mean, A, initial_conditions, etc.) ---
...
# =========================
# IMPORTANT: Ensure your baseline_forecast has 36 rows. Recompute if needed.
# baseline_forecast <- <your code to produce a 36-step baseline>  # ensure nrow = 36
...
# Oil target path for months 1..24 (in logs)
# If not already defined above, uncomment next 2 lines:
# last_oil_log <- tail(bvar_data_full[, "Oilprice"], 1)
# oil_target_path_25x24 <- as.numeric(last_oil_log + log(rep(1.25, 24)))
